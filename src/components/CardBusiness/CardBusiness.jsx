   ...
   return (
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-md overflow-hidden hover:shadow-lg transition">
         ...
         <div className="p-5">
            ...
            <span className="inline-block text-xs font-semibold bg-red-100 text-red-500 px-2 py-1 rounded-md mb-3">FAMILY OWNED</span>

            <h3 className="text-xl font-semibold text-gray-800">Green Bean Roastery</h3>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex -space-x-2">
            ...
            <div className="w-8 h-8 rounded-full bg-gray-300 border-2 border-white"></div>
               ...
               <span className="text-sm text-gray-500 font-medium">2k+ local fans</span>
            </div>
